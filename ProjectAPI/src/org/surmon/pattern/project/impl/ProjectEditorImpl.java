 ...
 * @author palasjiri
 */
@ServiceProvider(service = ProjectEditor.class)
public class ProjectEditorImpl implements ProjectEditor{
    ...
    public TopComponent getEditor(Project project) {
        ...
        // retrieve all possible implementations of ProjectEditor
        Collection<? extends ProjectEditorDescFactory> descriptions = Lookup.getDefault().lookupAll(ProjectEditorDescFactory.class);

        // go through all possible implementations of ProjectEditor and those
