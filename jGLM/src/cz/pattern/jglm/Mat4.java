...
public final class Mat4 extends AbstractMat {
     ...
     * the given array is larger than 16 elements; those elements will be
     * ignored.
     */
    ...
    /**
     * Similar as multiplication with translation matrix.
     *
    ...
    /**
     * Similar as multiplication with scale matrix.
     *
    ...
    public Mat4 scale(final Vec3 v) {
        Mat4 Result = new Mat4(
                this.<Vec4>getColumn(0).scale(v.x),
                this.<Vec4>getColumn(1).scale(v.y),
                this.<Vec4>getColumn(2).scale(v.z),
                this.<Vec4>getColumn(3)
        );
        return Result;
     ...
     * Similar as multiplication with scale matrix.
     *
     * @param v scale parameter same as scale with Vec3(v)
     * @return scaled matrix
     */
    public Mat4 scale(final float v) {
        Mat4 Result = new Mat4(
                this.<Vec4>getColumn(0).scale(v),
                this.<Vec4>getColumn(1).scale(v),
                this.<Vec4>getColumn(2).scale(v),
                this.<Vec4>getColumn(3)
        );
        return Result;
    }
